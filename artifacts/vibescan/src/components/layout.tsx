...
import { Shield, LayoutDashboard, Menu, X, Plus, BookOpen, Bell, Languages } from "lucide-react";
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            >
              <Bell className="w-3.5 h-3.5" /> {t("nav.monitor")}
            </Link>
            <Link
              href="/learn"
              className={cn(
            ...
            >
              <BookOpen className="w-3.5 h-3.5" /> {t("nav.learn")}
            </Link>
            ...
            >
              <Plus className="w-4 h-4" /> {t("nav.newScan")}
            </Link>
          </nav>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-background/95 backdrop-blur-xl border-b border-white/5 py-4 px-4 flex flex-col gap-3 shadow-2xl">
            ...
            <Link
              ...
              className="px-4 py-2 text-foreground font-medium rounded-lg hover:bg-secondary flex items-center gap-2"
            >
              <Bell className="w-4 h-4" /> {t("nav.monitor")}
            </Link>
            <Link
              href="/learn"
              onClick={() => setMobileMenuOpen(false)}
              className="px-4 py-2 text-foreground font-medium rounded-lg hover:bg-secondary flex items-center gap-2"
            >
              <BookOpen className="w-4 h-4" /> {t("nav.learn")}
            </Link>
